...
localparam
    ...
    ADDR_KERNEL_BASE = 8'h80,
    ADDR_KERNEL_HIGH = 8'hff,
    WRIDLE           = 2'd0,
    WRDATA           = 2'd1,
    WRRESP           = 2'd2,
    WRRESET          = 2'd3,
...
//------------------------Local signal-------------------
    ...
    // memory signals
    wire [4:0]                    int_kernel_address0;
    wire                          int_kernel_ce0;
    wire [31:0]                   int_kernel_q0;
    wire [4:0]                    int_kernel_address1;
    wire                          int_kernel_ce1;
    wire                          int_kernel_we1;
...
assign int_kernel_address1 = ar_hs? raddr[6:2] : waddr[6:2];

...
architecture behave of conv2d_stream_CTRL_s_axi is
    ...
    constant ADDR_KERNEL_BASE : INTEGER := 16#80#;
    constant ADDR_KERNEL_HIGH : INTEGER := 16#ff#;
    ...
    -- memory signals
    signal int_kernel_address0 : UNSIGNED(4 downto 0);
    signal int_kernel_ce0      : STD_LOGIC;
    signal int_kernel_q0       : UNSIGNED(31 downto 0);
    signal int_kernel_address1 : UNSIGNED(4 downto 0);
...
-- ----------------------- Memory logic ------------------
    ...
    int_kernel_address1  <= raddr(6 downto 2) when ar_hs = '1' else waddr(6 downto 2);

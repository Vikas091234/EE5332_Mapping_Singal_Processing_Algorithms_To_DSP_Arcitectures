...
-- ----------------------- Memory logic ------------------
    -- kernel
    int_kernel_address0  <= SHIFT_RIGHT(UNSIGNED(kernel_address0), 1)(2 downto 0);
    int_kernel_ce0       <= kernel_ce0;
    kernel_q0            <= STD_LOGIC_VECTOR(SHIFT_RIGHT(int_kernel_q0, TO_INTEGER(int_kernel_shift0) * 16)(15 downto 0));
        ...
        if (ACLK'event and ACLK = '1') then
            if (ARESET = '1') then
                ...
                if (kernel_ce0 = '1') then
                    int_kernel_shift0 <= UNSIGNED(kernel_address0(0 downto 0));
                end if;
            end if;
        end if;
    end process;

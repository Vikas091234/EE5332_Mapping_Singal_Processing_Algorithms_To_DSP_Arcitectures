...
architecture behave of conv2d_stream_CTRL_s_axi is
    ...
    constant ADDR_ROWS_DATA_0 : INTEGER := 16#0010#;
    constant ADDR_ROWS_CTRL   : INTEGER := 16#0014#;
    constant ADDR_COLS_DATA_0 : INTEGER := 16#0018#;
    constant ADDR_COLS_CTRL   : INTEGER := 16#001c#;
    constant ADDR_CIN_DATA_0  : INTEGER := 16#0020#;
    constant ADDR_CIN_CTRL    : INTEGER := 16#0024#;
    constant ADDR_COUT_DATA_0 : INTEGER := 16#0028#;
    constant ADDR_COUT_CTRL   : INTEGER := 16#002c#;
    constant ADDR_KERNEL_BASE : INTEGER := 16#1000#;
    constant ADDR_KERNEL_HIGH : INTEGER := 16#1fff#;
    ...
    -- memory signals
    signal int_kernel_address0 : UNSIGNED(9 downto 0);
    signal int_kernel_ce0      : STD_LOGIC;
    signal int_kernel_q0       : UNSIGNED(31 downto 0);
    signal int_kernel_address1 : UNSIGNED(9 downto 0);
    ...
    component conv2d_stream_CTRL_s_axi_ram is
        generic (
    ...
    end component conv2d_stream_CTRL_s_axi_ram;
...
-- ----------------------- Instantiation------------------
-- int_kernel
int_kernel : conv2d_stream_CTRL_s_axi_ram
generic map (
     MEM_STYLE => "auto",
     MEM_TYPE  => "2P",
     BYTES     => 4,
...
-- ----------------------- Memory logic ------------------
    ...
    int_kernel_address1  <= raddr(11 downto 2) when ar_hs = '1' else waddr(11 downto 2);
...
entity conv2d_stream_CTRL_s_axi_ram is
    generic (
        MEM_STYLE : STRING :="auto";
        MEM_TYPE  : STRING :="S2P";
        BYTES   : INTEGER :=4;
...
end entity conv2d_stream_CTRL_s_axi_ram;

architecture behave of conv2d_stream_CTRL_s_axi_ram is

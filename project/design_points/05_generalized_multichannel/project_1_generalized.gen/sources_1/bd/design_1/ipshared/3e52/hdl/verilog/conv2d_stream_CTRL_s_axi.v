...
#(parameter
    ...
    input  wire [9:0]                    kernel_address0,
...
localparam
    ...
    ADDR_IER         = 13'h0008,
    ADDR_ISR         = 13'h000c,
    ADDR_ROWS_DATA_0 = 13'h0010,
    ADDR_ROWS_CTRL   = 13'h0014,
    ADDR_COLS_DATA_0 = 13'h0018,
    ADDR_COLS_CTRL   = 13'h001c,
    ADDR_CIN_DATA_0  = 13'h0020,
    ADDR_CIN_CTRL    = 13'h0024,
    ADDR_COUT_DATA_0 = 13'h0028,
    ADDR_COUT_CTRL   = 13'h002c,
    ADDR_KERNEL_BASE = 13'h1000,
    ADDR_KERNEL_HIGH = 13'h1fff,
    WRIDLE           = 2'd0,
    WRDATA           = 2'd1,
    WRRESP           = 2'd2,
    WRRESET          = 2'd3,
...
//------------------------Local signal-------------------
    ...
    // memory signals
    wire [9:0]                    int_kernel_address0;
    wire                          int_kernel_ce0;
    wire [31:0]                   int_kernel_q0;
    wire [9:0]                    int_kernel_address1;
    wire                          int_kernel_ce1;
    wire                          int_kernel_we1;
...
assign int_kernel_address1 = ar_hs? raddr[11:2] : waddr[11:2];
assign int_kernel_ce1      = ar_hs | (int_kernel_write & WVALID);
assign int_kernel_we1      = int_kernel_write & w_hs;
assign int_kernel_be1      = int_kernel_we1 ? WSTRB : 'b0;
...
module conv2d_stream_CTRL_s_axi_ram
#(parameter
    MEM_STYLE = "auto",
    MEM_TYPE  = "S2P",
    BYTES  = 4,

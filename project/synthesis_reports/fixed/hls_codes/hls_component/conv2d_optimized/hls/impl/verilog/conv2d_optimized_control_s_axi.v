...
// ==============================================================
`timescale 1ns/1ps
(* DowngradeIPIdentifiedWarnings="yes" *) module conv2d_optimized_control_s_axi
#(parameter
...
//------------------------Local signal-------------------
    ...
    wire [0:0]                    kernel_shift0;
    reg  [0:0]                    int_kernel_shift0;

//------------------------Instantiation------------------
// int_kernel
conv2d_optimized_control_s_axi_ram #(
    .MEM_STYLE  ( "auto" ),
    .MEM_TYPE   ( "2P" ),
    .BYTE_WIDTH ( 8 ),
    .WIDTH      ( 32 ),
...
//------------------------Memory logic-------------------
// kernel
assign int_kernel_address0 = kernel_address0 >> 1;
assign int_kernel_ce0      = kernel_ce0;
assign kernel_q0           = int_kernel_q0 >> (int_kernel_shift0 * 16);
...
assign kernel_shift0       = kernel_address0[0:0];
// int_kernel_read
always @(posedge ACLK) begin
    if (ARESET)
...
module conv2d_optimized_control_s_axi_ram
#(parameter
    MEM_STYLE  = "auto",
    MEM_TYPE   = "S2P",
    BYTE_WIDTH = 8,
